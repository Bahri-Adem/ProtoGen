...
public final class TypeSpec {
  ...
  public final List<FieldSpec> classComponents;
  ...
  private TypeSpec(Builder builder) {
    ...
    this.classComponents = Util.immutableList(builder.classComponents);
  ...
  private TypeSpec(TypeSpec type) {
    ...
    this.classComponents = Collections.emptyList();
    this.varargs = false;
  ...
  public Builder toBuilder() {
    ...
    builder.classComponents.addAll(classComponents);
  ...
  private boolean emitHeader(CodeWriter codeWriter, String enumName,
    ...
    if (enumName != null) {
     ...
     // codeWriter.emitJavadoc(kind == Kind.CLASS
         // ? MethodSpec.makeJavadocWithParameters(javadoc, classComponents) : javadoc);
      codeWriter.emitAnnotations(annotations, false);
      ...
      // Class components.
     /* if (kind == Kind.CLASS) {
        MethodSpec.emitFeilds(codeWriter, classComponents, varargs);
      }*/
  ...
  public static final class Builder {
    ...
    public final List<FieldSpec> classComponents = new ArrayList<>();
    ...
    public Builder addClassComponents(Iterable<FieldSpec> parameterSpecs) {
      checkArgument(parameterSpecs != null, "fieldSpecs == null");
      for (FieldSpec parameterSpec : parameterSpecs) {
        addClassComponent(parameterSpec);
      }
      return this;
    }

    public Builder addClassComponent(FieldSpec parameterSpec) {
      classComponents.add(parameterSpec);
      return this;
    }
    ...
    public TypeSpec build() {
      ...
      if (!modifiers.isEmpty()) {
        ...
        if (kind == Kind.CLASS) {
          checkState(!modifiers.contains(Modifier.ABSTRACT), "abstract class");
        }
      }
      ...
      if (!classComponents.isEmpty()) {
        checkState(kind == Kind.CLASS, "%s is not class", this.name);

        for (FieldSpec classComponent : classComponents) {
          checkState(classComponent != null, "classComponents contain null");
          checkState(classComponent.modifiers.isEmpty(), "classComponents has modifier");
        }
      }
      ...
      boolean isAbstract = modifiers.contains(Modifier.ABSTRACT)
          || (kind != Kind.CLASS && kind != Kind.CLASS);
      for (MethodSpec methodSpec : methodSpecs) {
